...
g_list = [0,0.1,0.2]
L_list = [16,18,20,22]#OLD CODE: for a single choice of parameters, L = 18 only takes a few minutes, L = 20 takes about 9 minutes, L = 22 takes about 6 hours +- 1
...
for L in L_list:
    for g in g_list:
        for Delta_2 in Delta_2_list:
            print("L = %i, g=%.2f, Delta_2=%.2f" % (L,g,Delta_2))
            t0 = time.time()
